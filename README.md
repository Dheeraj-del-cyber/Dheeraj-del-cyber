<div align="center">
  ...
  <a href="https://github.com/Dheeraj-del-cyber">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=32&pause=1000&color=4F46E5&center=true&vCenter=true&width=600&lines=Hello%2C+I%27m+Dheeraj+Koila;Full+Stack+%26+AI+Engineer;IoT+%2B+ML+%2B+Web+Developer" alt="Typing SVG" />
  </a>
...
I am a results-driven software engineer specializing in full stack development, IoT systems, and artificial intelligence. I build practical solutions that connect web, mobile, and hardware platforms with modern machine learning capabilities.

- Current role: Team Lead, ASTRAians
- Core strengths: full stack architecture, IoT integration, AI/ML-powered products
- Location: India
- Focus: scalable, secure, and user-centered intelligent systems
...
| [Smart Destination Alert](https://github.com/Dheeraj-del-cyber/Smart-Destination-Alert) | GPS-based proximity alert system with location-aware haptic and audio feedback | `ESP32` `Geolocation API` `Web` |
